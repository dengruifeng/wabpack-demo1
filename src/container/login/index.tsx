...
export const Login: React.FC<any> = () => {
  ...
  return (
    <div className="login-box">
      <div className="login-box-left" style={{ display: critical ? 'none' : '' }}>
        <div className="login-box-left-img"></div>
        <div className="login-box-left-title">西湖的水</div>
        ...
        <div className="login-box-left-conter">分布式管控</div>
      </div>
      <div className="login-box-form">
        <div className="login-box-form-center">
          <div className="login-box-form-center-header">{renderHeader()}</div>
          <div className="login-box-form-center-title" style={isLogin ? { marginTop: '5%' } : {}}>
          ...
          <div className="login-box-form-center-bottom">
            ...
            <p>电话：00-10-0001212 传真：00-10-00011223 Email：exxx@epri.sgcc.com.cn</p>
          </div>
        </div>
      </div>
    </div>
